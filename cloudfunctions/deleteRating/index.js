// 云函数：删除一条评分（软删除，保留历史；早于今天需 confirmBeforeToday）
...
exports.main = async (event, context) => {
  ...
  try {
    const { recipeId, ratingId, confirmBeforeToday } = event
